...
public class Game extends Canvas implements Runnable
{
    ...
    public void run()
    {
        ...
        while (running)
        {
            ...
            {
                timer += 1000;
                frame.setTitle(title + " | " + ups + "ups | " + frames + " fps" + " | Player width and height: " + player.getWidth() + "(" + player.getCollisionBox().right  + ") " + player.getHeight() + "(" + player.getCollisionBox().bottom  + ") " + "| Player position: x " + player.getX() + " y " + player.getY() + "xScaleLocal " + player.xScaleLocal);
                ups = 0;
                frames = 0;
            }
        }
